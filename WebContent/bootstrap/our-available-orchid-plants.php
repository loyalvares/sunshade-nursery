		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 xs-box2">
					<h2 class="title-medium br-bottom">Orchid Plants</h2>
					<p>We offer orchid plants that fit any style and budget and also beautify your home with the display of aesthetic features including: flowers, leaves, scent, overall foliage texture, fruit, stem and bark, and aesthetic form.</p>
					<p>Decorative plants are plants that are grown for decorative purposes in gardens and landscape design projects, as houseplants, for cut flowers and specimen display. The cultivation of these, called floriculture, forms a major branch of horticulture.</p>
					<p><b>Orchids are our available decorative plants ...</b></p>
					<div class="mb40"></div>
				</div>
			</div>
		</div>
