		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 xs-box2">
					<h2 class="title-medium br-bottom">Flowering Plants</h2>
					<p><b>Flowering plants</b> are such type of plants, which have many verities plants of flowers. <b>Flower plants</b> are known as garden plants. These plants are growing by seeds, so these plants are called seed growing plants. Some flower plants are very rare to find and some are very casual. These plants produce fruits and then these fruits become make seeds. And again from these seeds, flower plants are growing. It is a cycle of flower plants. Flower plants are like Gerbera Plants, Roses Plants, Plumeria Plants (Red, Yellow, Black and White), Grafted Hybrid Adenium, Canna indica, Portlandia Grandiflora, Orchids, Brownea Grandiceps, Phalaenopsis Orchids, Bugambilia, Bel (Jasmine), Tagar (Crape Jasmin), Gulmohar (Royal Poinciana), Jaba (china rose or shoe flower), Jui (Jasmine Molle),   Kadam (Kadamba), Kunda (Star jasmine or kunda) etc.</p>
					<div class="mb40"></div>
				</div>
			</div>
		</div>
